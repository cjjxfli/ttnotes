...
use \Think\Log;
function write_toubao_log($message,$level){
    //初始化日志
    \Think\Log::init([
        'type'  =>  'File',
        'log_path'  =>  APP_PATH.'./logs/toubao/'
    ]);
    $log_path = APP_PATH.'./logs/toubao/'.date('Y_m_d').'_toubao.log';
    //写入日志
    \Think\Log::write($message,$level,'',$log_path);
}
 ...
 * @return boolean
 */
function toubao_send_mail($to, $name, $subject = '', $body = '', $attachment = null){
...
function email_code_body($user_name,$subject,$code){
    //邮件主体内容
    $email_body = '
<!DOCTYPE html>
<html>
...
<body>
    <div class="container">
        <p class="text-left h4">'.$subject.'</p>
        <p class="text-left bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;亲爱的'. $user_name.';<br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您的邮箱验证码为：
            <label class="error"><h4>'.$code.'</h4></label>
        </p>
    </div>
</body>
</html>';
...
function email_body($user_name,$subject,$token,$email_type){
    if($email_type == 1){
        //邮件主体内容
        $email_body = '<!DOCTYPE html>'.
            ...
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;感谢您注册我们的账号!<br>'.
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请点击激活您的账号,'.
            '<a href="http://'.$_SERVER["HTTP_HOST"].'/index.php/Home/User/active/token/' . $token . '" target='.
            '_blank">http://' . $_SERVER["HTTP_HOST"] . '/index.php/Home/User/active/token/' . $token . '</a><br/>'.
            '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果以上链接无法点击，请将它复制到你的浏览器地址栏中进入访问，该链接24小时内有效。</p>'.
            '</div>'.
            '</body>'.
            '</html>';
        return $email_body;
