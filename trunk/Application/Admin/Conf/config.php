...
//	'TMPL_ACTION_SUCCESS'    => THINK_PATH . 'Tpl/dispatch_jump.tpl', // 默认成功跳转对应的模板文件
    ...
    'COOKIE_PREFIX'  => 'smartweb_home_', // Cookie前缀 避免冲突
    ...
    'TMPL_PARSE_STRING' => array(
        '__STATIC__' => __ROOT__ . '/Public/statics',
		...
		'__UE__' => __ROOT__ . '/Public/lib/UEditor',
		'__UE_UPLOAD__' => __ROOT__ . "/Uploads/UE",
		'__UPLOADIFY__' => __ROOT__ . "/uploadify",
    ),
    /* 数据缓存设置 */
    ...
    'UPLOAD_QINIU_CONFIG'=>array(
        ...
        'bucket'=>'developerswiki',
        'domain'=>'developerswiki.net',
        'timeout'=>3600,
    ),
	...
	'SYSTEM_CLOSE_REGISTER' => false,
	'SYSTEM_CLOSE_ADMIN' => false,
	'WEB_SITE_VERIFY' => true,
	'VAR_URL_PARAMS'       => '_URL_', // PATHINFO URL参数变量
	'UPLOAD_FILE_PATH' => __ROOT__ . 'Uploads',
