...
$(function () {
    ...
    var ARTICLE_CMD = 2;
    var FAVORITES_CMD = 3;
    var FAVORITESCATEGORY_CMD = 4;
    var SOFTWARE_CMD = 5;
    var SOFTWARECATEGORY_CMD = 6;
    //全局node click事件
    ...
    function __copy(url) {
        ...
        $("#fileTreeDialog").delegate(".plus", "click", function () {
            ...
            if (FAVORITESCATEGORY_CMD == cmd_type) {
    ...
    $("#btn-download").on('click', function () {
        //alert("btn-download");
        var on_cmd_req_href = $("#menu").attr("data-on-cmd-req-file");
        var url = on_cmd_req_href + "/downloadArticle";
        downloadArticle(url);
    });
